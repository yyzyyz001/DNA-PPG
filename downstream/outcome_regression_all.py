...
if __name__ == "__main__":
    ...
    config = {
        1: {"dataset": "ppg-bp", "label": "sysbp", "linear_model": "ridge", "level": get_content_type("ppg-bp"), "content": get_content_type("ppg-bp"), "string_convert": False, 'percent': percent},
        2: {"dataset": "ppg-bp", "label": "diasbp", "linear_model": "ridge", "level": get_content_type("ppg-bp"), "content": get_content_type("ppg-bp"), "string_convert": False, 'percent': percent},
        3: {"dataset": "ppg-bp", "label": "hr", "linear_model": "ridge", "level": get_content_type("ppg-bp"), "content": get_content_type("ppg-bp"), "string_convert": False, 'percent': percent},
        4: {"dataset": "dalia", "label": "hr", "linear_model": "ridge", "level": get_content_type("dalia"), "content": get_content_type("dalia"), "string_convert": False, 'percent': percent},
        5: {"dataset": "vv", "label": "sysbp", "linear_model": "ridge", "level": get_content_type("vv"), "content": get_content_type("vv"), "string_convert": False, 'percent': percent},
        6: {"dataset": "vv", "label": "diasbp", "linear_model": "ridge", "level": get_content_type("vv"), "content": get_content_type("vv"), "string_convert": False, 'percent': percent},
    }
