...
if __name__ == "__main__":
    ...
    simclr_dir = f"{args.save_dir}/simclr"
    if not os.path.exists(simclr_dir):
        os.mkdir(simclr_dir)
    save_dir = f"{simclr_dir}/{args.split}/"
    ...
    save_path = os.path.join(simclr_dir, f"dict_{args.split}_{content}.p")
